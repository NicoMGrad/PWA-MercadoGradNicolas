window.addEventListener('DOMContentLoaded', function(){
    ...
    function estiloClima(data) {
        ...
        titulo.innerHTML = `${data.main.temp}º <img src="img/${data.weather[0].main}.svg" id="icono" />`;
            localStorage.setItem("titulo",`${data.main.temp}º <img src="img/${data.weather[0].main}.svg" id="icono" />`);
